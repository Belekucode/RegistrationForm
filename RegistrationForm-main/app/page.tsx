        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                <Label htmlFor="socialBehaviorDescription">Social Communication</Label>
                <Textarea
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Information about the vocational rehabilitation counselor, if any</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
